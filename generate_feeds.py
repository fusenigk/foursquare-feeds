...
# kf added 20019-10-18
# see https://github.com/philgyford/foursquare-feeds
...
class FeedGenerator:
   ...
   def _generate_calendar(self, checkins):
       ...
       for checkin in checkins:
           ...
           e.name = "@ {}".format(venue_name.encode('ascii', 'ignore'))           
           e.location = venue_name.encode('ascii', 'ignore')
           ...
           location = venue_name.encode('ascii', 'ignore')
           ##location = "hello"
           ...
           if "location" in checkin["venue"]:
               ...
               if "formattedAddress" in loc and len(loc["formattedAddress"]) > 0:
                   ...
                   location = "{}, {}".format(location.encode('ascii', 'ignore'), address.encode('ascii', 'ignore'))
